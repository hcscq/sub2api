...
const (
	...
	defaultAntigravityVersion = "1.23.2"
)

// defaultUserAgentVersion 可通过环境变量 ANTIGRAVITY_USER_AGENT_VERSION 配置，默认 1.23.2
var defaultUserAgentVersion = defaultAntigravityVersion
...
func GetUserAgent() string {
	return fmt.Sprintf("antigravity/%s windows/amd64", GetIDEVersion())
}

// GetIDEVersion 返回当前 Antigravity 客户端版本，用于请求 metadata。
