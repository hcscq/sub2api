...
const openaiPresetMappings = [
  ...
  { label: 'Opus4.7→5.4', from: 'claude-opus-4-7', to: 'gpt-5.4', color: 'bg-fuchsia-100 text-fuchsia-700 hover:bg-fuchsia-200 dark:bg-fuchsia-900/30 dark:text-fuchsia-400' },
